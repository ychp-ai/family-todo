...
2026-09-15 性能优化及 3 个新增索引已部署，见 [性能落地记录](../docs/technical/API_PERFORMANCE_IMPLEMENTATION.md) 和 [索引迁移记录](performance-provision-result.json)。2026-09-17 已执行一次过期会话清理，并部署每天北京时间 00:00、12:00 执行的云端清理任务，见 [定时清理](../docs/technical/QUERY_SESSION_CLEANUP.md)。
