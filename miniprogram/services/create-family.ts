...
export function readCreateFamily(identity: RecoveryIdentity, families: readonly { id: string }[]): string | null | undefined {
  ...
  try {
    ...
    return families.some(family => family.id === value) ? value : null;
