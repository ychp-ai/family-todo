import type { PersonalActionMap, TaskDTO } from "@family-todo/contracts";
...
export function selectTask(selected:TaskDTO[],task:TaskDTO):TaskDTO[]{
...
export function batchPayload(tasks:TaskDTO[],groups:BatchGroup[]):BatchPayload {
