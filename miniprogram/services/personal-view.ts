import type { OccurrenceRef, PersonalDraft } from "@family-todo/contracts";
...
export function occurrenceRef(o: OccurrenceRef): OccurrenceRef { return {id:o.id,taskId:o.taskId,segmentId:o.segmentId,localDate:o.localDate,slot:o.slot}; }
...
export function occurrenceUrl(o: import("@family-todo/contracts").OccurrenceRef):string {return `/pages/detail/index?id=${encodeURIComponent(o.taskId)}&occurrence=${encodeURIComponent(JSON.stringify(occurrenceRef(o)))}`;}
