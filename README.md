...
面向家庭成员协作的微信小程序。当前已实现身份接入、家庭待办、成员协作、每日/每周周期、小程序内提醒、家人进度与批量追加可见人。真实部署与验收范围见发布记录。

新建事项必须先创建或加入家庭，并选择所属家庭；历史个人事项的指定家庭迁移尚待执行。此次限制仅在本地实现，云端发布状态见发布记录。
...
- 按家庭/日期/执行对象查看可见进度，最多 20 项批量追加可见人；历史个人事项可明确选择家庭后迁移；未完成批次可续办。
